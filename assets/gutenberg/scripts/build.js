...
const fileBuildJS = path.resolve( theCWD, './dist/gutenberg/blocks.build.js' );
//const fileEditorCSS = path.resolve( theCWD, './dist/gutenberg/blocks.editor.build.css' );
//const fileStyleCSS = path.resolve( theCWD, './dist/gutenberg/blocks.style.build.css' );
