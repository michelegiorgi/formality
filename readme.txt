...
= 1.5 =
Release Date: Jan 2nd, 2022

* Completely rewritten frontend script with modern syntax and no dependencies
* Frontend assets cleanup/optimization ¹
* Add border radius support
* Add filled style input
